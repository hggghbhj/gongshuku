#!/usr/bin/env python3
"""伊玛电子 EMA 下载中心采集器
多下载页PDF直链: https://www.ema-electronic.com/upload/xxx.pdf
"""
import json, os, time, urllib.request, urllib.parse, subprocess, re, sys

BASE = os.path.dirname(os.path.abspath(__file__))
PDF_DIR = os.path.join(BASE, '..', 'pdfs', 'ema')
MANIFEST = os.path.join(BASE, 'ema_manifest.json')
PAGES = [
    'https://www.ema-electronic.com/download.html',
    'https://www.ema-electronic.com/downloadml.html',
    'https://www.ema-electronic.com/downloadggs.html',
    'https://www.ema-electronic.com/downloadsms.html',
]
HEADERS = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36',
           'Referer': 'https://www.ema-electronic.com/'}
...
def run():
        ...
        try:
            ...
            for url in pdfs:
                if url.startswith('//'):
                    ...
                    url = 'https://www.ema-electronic.com' + url
                elif not url.startswith('http'):
                    url = 'https://www.ema-electronic.com/' + url
                if 'ema-electronic' not in url: continue
    ...
    for d in to_download:
        ...
        try:
            ...
            manifest.append({
                ...
                'brand': '伊玛电子', 'src': 'ema-electronic.com',
            })
            ok += 1
        except Exception as e:
            fail += 1
    ...
    print(f'伊玛电子完成: 新增{ok}, 失败{fail}, 总计{len(manifest)}')
    return {'brand': 'ema', 'new': ok, 'fail': fail, 'total': len(manifest)}
